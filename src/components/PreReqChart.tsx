  ...
  const renderCourse = (course: Course) => {
    ...
    return (
      ...
      >
        ...
        >
          <div
            className={`text-center text-xs sm:text-sm ${darkMode ? 'text-gray-100' : 'text-black'}`} 
            style={{
            display: 'flex',
            alignItems: 'center',
        ...
        <div className="h-full flex items-center justify-between px-4">
          <div className="flex items-center gap-2">
            <span className={`text-xs sm:text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Made by{' '}
              <a href="https://www.linkedin.com/in/taha-lahlou/" target="_blank" rel="noopener noreferrer"
          ...
          <a
            href="https://github.com/tahalahlou"
            target="_blank"
